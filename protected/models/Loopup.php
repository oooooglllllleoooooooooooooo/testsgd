 ...
 */
class Loopup extends CActiveRecord
{
        ...
        private static function loadItems($type)
        {
            ...
            $models = self::model()->findAll(array('condition'=>'type=:type',
                'params'=>array(':type'=>$type),'order'=>'position',));
	 ...
	 * @return Loopup the static model class
	 */
